...
new Vue({
    ...
    data: {
        ...
        newMsg: "",
        searchMsg: "",
        dropI: -1, // -1 perchè di default non deve vedersi su nessuno
        dropActive: "",
    },
    methods: {
        ...
        userI: function (index)
        {
            ...
            this.newMsg = "",
                // ritardo di 1s la risposta automatica
                setTimeout(() =>
                {
        ...
        searchContact()
        {
            ...
            {
                if (el.name.toLowerCase().includes(this.searchMsg)) {
                    el.visible = true;
                } else {
                    el.visible = false;
                }
        ...
        // dropdown
        dropdownPopup: function (i)
        {
            this.dropI = i;
            if (this.dropActive === "") {
                this.dropActive = "active";
            } else if (this.dropActive === "active") {
                this.dropActive = "";
            }
        },
    ...
    updated()
    {
        // Viene chiamata quando il componente viene aggirnato
        this.scrollToEnd();
    },
});